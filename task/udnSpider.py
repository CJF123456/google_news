...
# 联合新闻
class UdnSpider(object):
    def __init__(self):
        # 来源
        self.mmd5 = 'google:udn'
        self.project_name = self.__class__.__name__
        self.web_name = "联合新闻网"
        self.first_url = "https://udn.com"
    ...
    def get_content_html(self, html):
        ...
        con_htmls = []
        for divcon in soup.select('section.article-content__editor'):
            ...
            if "<p>【更多精采" in con_html:
                con_html = con_html.split("<p>【更多精采")[0]
    ...
    def get_image_url(self, con):
        html = etree.HTML(con)
        try:
            image_url = html.xpath('//figure//img/@src')[0]
    ...
    def get_caption(self, con):
        html = etree.HTML(con)
        try:
            caption = html.xpath('//figure//img/@title')[0]
